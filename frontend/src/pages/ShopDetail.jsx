...
const ShopDetail = () => {
    ...
    const fetchData = async () => {
        try {
            const [shopRes, loansRes, paymentsRes] = await Promise.all([
                api.get(`/shops/${id}`),
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="card mb-6">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <span className="badge badge-info mb-2">{shop.code}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="font-semibold text-gray-800">{shop.phone}</p>
                    </div>
                    <div>
                        <p className="text-sm text-gray-600">Village</p>
                        <p className="font-semibold text-gray-800">{shop.village}</p>
                    </div>
                    <div>
                        <p className="text-sm text-gray-600">Registered</p>
                        <p className="font-semibold text-gray-800">{formatDate(shop.registerDate)}</p>
                    </div>
                </div>
                ...
                <div className="border-t pt-6">
                    <div className="flex justify-between items-center">
                        ...
                        <span className={`text-3xl font-bold ${shop.totalOutstanding > 0 ? 'text-red-600' : 'text-green-600'}`}>
